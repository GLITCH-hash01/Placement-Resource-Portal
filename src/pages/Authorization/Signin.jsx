  ...
  return (
    <>
      <div className="w-screen h-fit flex fixed justify-around items-center gap-200 p-4">
        ...
        <button
          className="bg-primary px-8 border-2 rounded-xl  border-black py-2 cursor-pointer font-primary font-bold"
      ...
      <div className="flex justify-center items-center px-8 relative font-primary gap-8 h-screen ">
        <div className="flex justify-center items-center absolute left-[20%] ">
        ...
        <div className="flex justify-around items-center absolute right-[10%]">
